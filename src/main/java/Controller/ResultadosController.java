...
public class ResultadosController {
    ...
    // Muestra la clasificación final ordenada por posición
    private void cargarResultadosCarrera() {
        ...
        for (CarreraCaballo cc : inscripciones) {
            ...
            String texto = cc.getPosicionFinal() + ". " + c.getNombre() + " | No. " + c.getNumero();
    ...
    // Muestra el resultado de cada apuesta del usuario en esta carrera
